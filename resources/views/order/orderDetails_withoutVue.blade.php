...
<div class="order_details_latest">
    <div class="container mt-5">
        <div class="row no-gutters">
            <div class="col-md-7 col-sm-7">
                <h4>ORDER DETAILS (for last two month)</h4>
            </div>
            <div class="col-md-5 col-sm-5">
                <form action="" class="orderdetail_by_term">
                    From <input type="date" value="" name="fromDate" class="form-contorl from_date" required autofocus> To
                    <input type="date" value="" name="toDate" class="form-contorl to_date" required>
...
@section('extra-js')
<script src="{{ asset('myJs/order/orderDetails.js') }}"></script>
@endsection
